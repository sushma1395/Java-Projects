...
public class AnalysisHelper {
    ...
    public void getPostWithMostLikedComment() {
        ...
        public void gettop5inactiveandproactiveusersoverll()
    {
        Map<Integer, User> users = DataStore.getInstance().getUsers();
        Map<Integer, Post> posts = DataStore.getInstance().getPosts();
        Map<Integer, Comment> comments = DataStore.getInstance().getComments(); 
      ...
      int sizeOfArray = entryList.size();
      int lastElement = sizeOfArray-1;
      
      System.out.println("All users and their activity :");
      for(Map.Entry<Integer, Integer> entry: entryList ){
          System.out.println("Userid: "+" [id]:"+entry.getKey() + " [count]:"+entry.getValue());
      }
      
        System.out.println("Top 5 inactive users overall based on comments and posts :");
        int j=0;
      for(Map.Entry<Integer, Integer> entry: entryList ){
          if(j<5){
          System.out.println("Userid: "+" [id]:"+entry.getKey() + " [count]:"+entry.getValue());
      ...
      System.out.println("Top 5 proactive users overall based on comments and posts :");
      for(int i=0; i<5; i++){
          Map.Entry<Integer, Integer> entry = entryList.get(lastElement);
          System.out.println("Userid: "+" [id]:"+entry.getKey() + " [count]:"+entry.getValue());
          lastElement--;
      }
    }    
