...
public class AnalysisHelper {
       ...
       int revenue=0;
        for(Order o :orders.values()){
           for(Item item: o.getItem())
           {
             ...
             System.out.println("_________________________________________________");
             System.out.println("Total revenue for the year (revenue = quantity * price per quantity)");
    ...
    public void profitForTheYear(){
       ...
       int profit=0;
        ...
        System.out.println("_________________________________________________");
        System.out.println("Total revenue/profit for the year ((revenue_per_product = selling_price - min_price) * quantity)");
